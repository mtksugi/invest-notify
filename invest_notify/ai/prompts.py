...
- **IR（category=ir）は狭く扱う**：
  ...
  - 役員人事、一般的なReg FD、項目だけで中身が不明な8-Kは原則通知しない。
  - `Material Definitive Agreement` や `Reg FD` という見出しだけで、相手先・金額・希薄化条件・担保/コベナンツ・対価・解除条件などの具体が無いものは early_warning に逃がさず棄却寄りにする。
